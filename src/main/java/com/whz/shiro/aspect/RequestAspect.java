...
import com.whz.shiro.utils.ThreadLocalContext;
...
public class RequestAspect {
     ...
     */
    @Pointcut("execution( * com.whz.*.controller..*(..))")
    ...
    public void saveExceptionLog(JoinPoint joinPoint, Throwable e) {
        ...
        String exception = StringUtils.getPackageException(e, "com.whz");
